...
//	
//	private ArrayList<Items> itemToPickupList = new ArrayList<Items>();
//	private Items itemToPickup = null;
...
//	}
//	
//	public void setItemToPickup(int x) {
//		itemToPickup = itemToPickupList.get(x);
//	}
//	
//	public void pickUpItem() {
//		if(gameState.equalsIgnoreCase("Item Pick Up Monster")) {
//			//Random look class later
//		}else if(gameState.equalsIgnoreCase("Item Pick Up Room")) {
...
//				if(itemIterator.equals(itemToPickup)) {
...
//			}			
//		}
//		player.getCurrentRoom().getRoomItem().get(x)
//	}
//	
//	public void setItemDrop(Items item) {
//		itemDrop.add(item);
//	}
//	public ArrayList<Items> getItemDrop() {
//		return itemDrop;
//	}
//	public Items getSpecificItemDrop(int x) {
//		return itemDrop.get(x);
//	}
//	public void clearItemDrop() {
//		itemDrop.remove;
//	}
//	
//
